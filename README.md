...
1: I create an array, and each time the user adds a new item, this item will be pushed to the array. We make sure to clear the ul, then we create a for loop in this array. In this for loop, we create a li element with the help of
...
with the help of DOM, that we update the price correctly. When we add new data, we will add all price datasets together, when we remove it, we will decrease the price dataset fromthe  total, and when we update it, we will
